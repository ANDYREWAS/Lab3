...
SOURCEFILES_QUOTED_IF_SPACED=Lab3v2_main.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Lab3v2_main.o
POSSIBLE_DEPFILES=${OBJECTDIR}/Lab3v2_main.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Lab3v2_main.o

# Source Files
SOURCEFILES=Lab3v2_main.s
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/Lab3v2_main.o: Lab3v2_main.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Lab3v2_main.o 
	${MP_AS} -mcpu=PIC16F887 -c \
	-o ${OBJECTDIR}/Lab3v2_main.o \
	Lab3v2_main.s \
